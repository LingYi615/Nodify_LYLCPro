...
namespace WhileLoopPlugin
{
    ...
    /// - 不包含任何逻辑运算，仅作为容器/子图
    /// </summary>
    public class WhileLoopOperationViewModel : NotifyPropertyBase, IExecutableOperation, ISerializableOperation, IConnectionAware
    {
        #region 静态资源
        ...
        public void OpenSubEditor()
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine("[WhileLoop.OpenSubEditor] ParentEditor 未注入，无法展开");
                return;
            }
            ...
            System.Diagnostics.Debug.WriteLine($"[WhileLoop.OpenSubEditor] 已展开子画布: {Title}");
        }

        /// <summary>
        /// 同步入口/出口节点到子画布（增量更新，保留已有连线）
        /// 入口节点对应 WhileLoop 的 Inputs，出口节点对应 WhileLoop 的 Outputs
        /// </summary>
        ...
        private void RestoreSubEditorConnections()
        {
            ...
            System.Diagnostics.Debug.WriteLine(
                $"[WhileLoop.RestoreSubEditorConnections] 已恢复子画布连线");
        }
    ...
    /// <summary>
    /// 子画布入口节点（数据从 WhileLoop Input 流入，向内部节点输出）
    /// </summary>
    ...
    /// <summary>
    /// 子画布出口节点（从内部节点接收数据，流向 WhileLoop Output）
    /// </summary>
