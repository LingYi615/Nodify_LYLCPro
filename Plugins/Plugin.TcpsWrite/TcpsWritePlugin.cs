...
namespace TcpsWritePlugin
{
    /// <summary>
    /// TCP 写入插件
    /// 输入 TCPAgreement 通讯实例 + 写入变量，将数据写入设备
    /// 输出 outflag（可选）
    /// </summary>
    [Plugin("TCP写入", Description = "TCP或PLC协议写入",
            Version = "1.0.0",
            Author = "LYCorePro",
    ...
    [PluginTag("TCP写入")]
    public class TcpsWritePlugin : PluginBase.Base.PluginBase
    {
        public static readonly IValueConverter NullToVisibilityConverter = new NullToVisibilityConverterImpl();

        public override string Name => "TCP 写入";
        public override Version Version => new(1, 0, 0);
        public override string Description => "TCP 数据写入插件，将变量数据写入到通讯实例中";
        public override string Author => "LYCorePro";

        public override Type[] OperationTypes => new[] { typeof(TcpsWriteOperationViewModel) };
        ...
        public override void Initialize(IPluginHost host)
        {
            ...
            if (!Application.Current.Resources.Contains(typeof(TcpsWriteOperationViewModel)))
            {
                Application.Current.Resources.Add(typeof(TcpsWriteOperationViewModel), nodeTemplate);
            }
        }

        public override DataTemplate? GetTemplate(Type operationType)
        {
            if (operationType == typeof(TcpsWriteOperationViewModel))
            {
...
<DataTemplate xmlns=""http://schemas.microsoft.com/winfx/2006/xaml/presentation""
              ...
              xmlns:local=""clr-namespace:TcpsWritePlugin;assembly=Plugin.TcpsWrite""
              DataType=""{x:Type local:TcpsWriteOperationViewModel}"">
...
<DataTemplate xmlns=""http://schemas.microsoft.com/winfx/2006/xaml/presentation""
              ...
              mc:Ignorable=""d""
              d:DataContext=""{d:DesignInstance Type=local:TcpsWriteOperationViewModel}"">
                        ...
                        <StackPanel>
                            ...
                            <Grid Margin=""0,0,0,8"">
                                ...
                                <ComboBox Grid.Column=""1""
                                          ItemsSource=""{x:Static local:TcpsWriteOperationViewModel.InOutDataTypes}""
                                            ...
                                            <GridViewColumn.CellTemplate>
                                                <DataTemplate>
                                                    <ComboBox SelectedItem=""{Binding DataType}""
                                                              ItemsSource=""{x:Static local:TcpsWritePlugin.DataTypeOptions}""
                                                              Height=""22"" FontSize=""11""   MinWidth=""70""
                                                              Background=""#45475A"" Foreground=""#CDD6F4""
                                                              BorderThickness=""0""
            ...
            <ScrollViewer VerticalScrollBarVisibility=""Auto"">
                <StackPanel Margin=""0,8,0,0"">
                    ...
                    <Border Background=""#181825"" BorderBrush=""#313244""
                            BorderThickness=""1"" CornerRadius=""4""
                            Padding=""10"" Margin=""0,0,0,12""
                            Visibility=""{Binding InputInfo, Converter={x:Static local:TcpsWritePlugin.NullToVisibilityConverter}, FallbackValue=Collapsed}""
                            >
                            <StackPanel>
