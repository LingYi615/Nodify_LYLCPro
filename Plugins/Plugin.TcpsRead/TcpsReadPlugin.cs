...
namespace TcpsReadPlugin
{
    /// <summary>
    /// TCP 读取插件
    /// 输入 TCPAgreement 通讯实例，通过注册读取变量来获取数据
    /// 输出动态生成的变量列表，每个变量对应一个输出连接器
    /// </summary>
    [Plugin("TCP读取", Description = "TCP或PLC协议读取",
            Version = "1.0.0",
            Author = "LYCorePro",
    ...
    [PluginTag("TCP读取")]
    public class TcpsReadPlugin : PluginBase.Base.PluginBase
    {
        ...
        public override string Name => "TCP 读取";
        public override Version Version => new(1, 0, 0);
        public override string Description => "TCP 数据读取插件，从通讯实例中读取指定的变量数据";
        public override string Author => "LYCorePro";

        public override Type[] OperationTypes => new[] { typeof(TcpsReadOperationViewModel) };
        ...
        public override void Initialize(IPluginHost host)
        {
            ...
            if (!Application.Current.Resources.Contains(typeof(TcpsReadOperationViewModel)))
            {
                Application.Current.Resources.Add(typeof(TcpsReadOperationViewModel), nodeTemplate);
            }
        }

        public override DataTemplate? GetTemplate(Type operationType)
        {
            if (operationType == typeof(TcpsReadOperationViewModel))
            {
...
<DataTemplate xmlns=""http://schemas.microsoft.com/winfx/2006/xaml/presentation""
              ...
              xmlns:local=""clr-namespace:TcpsReadPlugin;assembly=Plugin.TcpsRead""
              DataType=""{x:Type local:TcpsReadOperationViewModel}"">
...
<DataTemplate xmlns=""http://schemas.microsoft.com/winfx/2006/xaml/presentation""
              ...
              mc:Ignorable=""d""
              d:DataContext=""{d:DesignInstance Type=local:TcpsReadOperationViewModel}"">
                        ...
                        <StackPanel>
                            ...
                            <Grid Margin=""0,0,0,8"">
                                ...
                                <ComboBox Grid.Column=""1""
                                          ItemsSource=""{x:Static local:TcpsReadOperationViewModel.InOutDataTypes}""
                                          SelectedItem=""{Binding InFlagDataType}""
                                          Height=""24"" FontSize=""11"" Margin=""18,0,0,0""
                                            ...
                                            <GridViewColumn.CellTemplate>
                                                <DataTemplate>
                                                    <ComboBox SelectedItem=""{Binding DataType}""
                                                              ItemsSource=""{x:Static local:TcpsReadPlugin.DataTypeOptions}""
                                                              Height=""22"" FontSize=""11"" MinWidth=""70""
                                                              Background=""#45475A"" Foreground=""#CDD6F4""
                                                              BorderThickness=""0""
            ...
            <ScrollViewer VerticalScrollBarVisibility=""Auto"">
                <StackPanel Margin=""0,8,0,0"">
                    ...
                    <Border Background=""#181825"" BorderBrush=""#313244""
                            BorderThickness=""1"" CornerRadius=""4""
                            Padding=""10"" Margin=""0,0,0,12""
                            Visibility=""{Binding InputInfo, Converter={x:Static local:TcpsReadPlugin.NullToVisibilityConverter}, FallbackValue=Collapsed}"">
                        <StackPanel>
                    ...
                    <Border Background=""#181825"" BorderBrush=""#313244""
                            BorderThickness=""1"" CornerRadius=""4""
                            Padding=""10"" Margin=""0,0,0,12""
                            Visibility=""{Binding OutputInfo, Converter={x:Static local:TcpsReadPlugin.NullToVisibilityConverter}, FallbackValue=Collapsed}"">
                        <StackPanel>
